  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100 h-16 flex items-center justify-between px-6 md:hidden">
      ...
      <div className="flex items-center gap-4">
        <button onClick={() => navigate('/my-bookings')} aria-label="My bookings"
          className="relative p-2 text-tropic-green/50 hover:bg-tropic-sand/30 rounded-xl transition-colors">
          <UilBell size="20" />
        </button>
