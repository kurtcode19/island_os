...
import { AlertTriangle, X, Send, MapPin, Phone, CheckCircle2, Loader } from 'lucide-react';
              ...
              {submitted ? (
                <div className="p-12 text-center">
                  <div className="w-20 h-20 bg-island-emerald/10 rounded-full flex items-center justify-center mx-auto mb-6">
                    <CheckCircle2 size={48} className="text-island-emerald" />
                  </div>
                ...
                <>
                  ...
                  <div className="p-8 space-y-6">
                    ...
                    <div className="flex gap-4">
                      ...
                      >
                        {submitting ? <Loader size={20} className="animate-spin" /> : <AlertTriangle size={20} />}
                        SOS Emergency
                      </button>
                      <button
